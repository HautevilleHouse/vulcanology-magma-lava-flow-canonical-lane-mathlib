import VulcanologyMagmaLavaFlowCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate internalized through magma rheology, lava flow equations, eruption parameters, and thermal boundary layer analysis",
